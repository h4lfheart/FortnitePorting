...
namespace FortnitePorting.Rendering.Data.Programs;
...
public class ShaderProgram : Program
{
    ...
    private int CompileShader(string name, ShaderType type)
    {
        ...
        var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"FortnitePorting.Rendering.Shaders.{name}.{ext}")!;
