...
public partial class HelpViewModel : ViewModelBase
{
    ...
    [ObservableProperty, NotifyPropertyChangedFor(nameof(BuilderButtonText))]
    ...
    public override async Task OnViewOpened()
    {
        ...
        AppWM.UpdateChippy([
            "it's like a little wikipedia for fortnite porting",
            "we love the support staff that make help articles, they're awesome", "i’m here to help!! kinda!!",
    ...
    {
        Info.Dialog("Are you sure you would like to upload?",
            "Please make sure that all of these changes are final before uploading your article.", buttons:
            [
                new DialogButton
                {
                    Text = "Upload",
                    Action = async () =>
                    {
                        ...
                        if (string.IsNullOrWhiteSpace(newArticle.Description))
                        ...
                        Info.Message("Uploaded Article",
                            $"Successfully uploaded help article entitled \"{newArticle.Title}\"");
