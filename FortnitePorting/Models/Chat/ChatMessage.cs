...
public partial class ChatMessage : ObservableObject
{
    ...
    public string UserTitleText => IsPrivate ? $"Message {(User.DisplayName.Equals(AppSettings.Current.Online.Identification?.DisplayName) ? $"To {TargetUserName}" : $"From {User.DisplayName}")}" : User.DisplayName;
