...
with zipfile.ZipFile('Release/BlenderFortnitePortingServer.zip', 'w', zipfile.ZIP_DEFLATED) as server_zip:
...
with zipfile.ZipFile('Release/FortnitePorting.zip', 'w', zipfile.ZIP_DEFLATED) as main_zip:
    ...
    main_zip.write("Release/BlenderFortnitePortingServer.zip", "BlenderFortnitePortingServer.zip")

os.remove("Release/FortnitePorting.exe")
os.remove("Release/BlenderFortnitePortingServer.zip")
